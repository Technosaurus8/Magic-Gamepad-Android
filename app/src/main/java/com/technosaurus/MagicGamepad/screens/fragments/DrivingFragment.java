...
import com.technosaurus.MagicGamepad.screens.fragments.PlayerSelectDialogFragment;
...
public class DrivingFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (!isBtHid && (savedInstanceState == null || host.getPlayer().isEmpty())) {// no player select dialog is needed for BtHid because system will auto assign
